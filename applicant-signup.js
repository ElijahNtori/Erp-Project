document.addEventListener('DOMContentLoaded', function() {
    const applicantSignupForm = document.getElementById('applicantSignupForm');
    
    applicantSignupForm.addEventListener('submit', function(e) {
        e.preventDefault();
        ...
        const existingUser = applicants.find(u => u.email === email);
